...
export function ProductItem(item) {
  return (
    <div className="flex flex-col relative cursor-pointer">
      ...
      <div className="flex  items-center mx-[50px] mt-5 justify-between mb-5">
      ...
      <span className="text-[14px] leading-[17px] font-[400] text-[#023047] opacity-70 text-center mb-5">
        Louis Widmer
      </span>
      <div className="flex items-center mx-[64px] mb-[32px]">
        ...
        {item.src.price ? (
          ...
          <span className="flex items-center justify-start ml-[25px] text-[#01AEAB] text-[18px] font-[600] text-center ">
            {item.src.priceSale} <p className="ml-[2px]">SAR</p>
          </span>
        )}
      </div>
